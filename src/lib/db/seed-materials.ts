...
Forgetting the ± sign, sign errors when b is negative, and dividing both sides by x, which loses the solution x = 0.`,
  ...
  {
    key: "quadratic-worked-ka",
    owner: "nino",
    title: "კვადრატული განტოლებები — ამოხსნილი მაგალითები",
    subject: "mathematics",
    grade: 11,
    author: "ნინო ბერიძე",
    tags: ["ალგებრა", "სამუშაო ფურცელი", "მაგალითები"],
    visibility: "students",
    fileName: "kvadratuli-gantolebebi.md",
    daysAgo: 14,
    text: `# კვადრატული განტოლებები — ამოხსნილი მაგალითები

## სტანდარტული სახე
კვადრატულ განტოლებას აქვს სახე ax² + bx + c = 0, სადაც a ნულის ტოლი არ არის. ამოხსნამდე ყველა წევრი ტოლობის ერთ მხარეს გადაიტანე.

## პირველი ხერხი: მამრავლებად დაშლა
მაგალითი: x² − 7x + 10 = 0. გვჭირდება ორი რიცხვი, რომელთა ნამრავლია 10, ხოლო ჯამი −7: ეს რიცხვებია −2 და −5. ამიტომ (x − 2)(x − 5) = 0 და x = 2 ან x = 5.

რჩევა: პასუხი შეამოწმე — ჩასვი ის საწყის განტოლებაში.

## მეორე ხერხი: ფესვების ფორმულა
x = (−b ± √(b² − 4ac)) / (2a). მაგალითი: x² + 4x + 1 = 0 განტოლებისთვის D = 16 − 4 = 12, ამიტომ x = (−4 ± √12) / 2 = −2 ± √3.

## დისკრიმინანტი
D = b² − 4ac. დისკრიმინანტი გამოიყენება იმის დასადგენად, რამდენი ნამდვილი ფესვი აქვს განტოლებას: თუ D > 0, ორი ნამდვილი ფესვია; თუ D = 0 — ერთი (ორჯერადი) ფესვი; თუ D < 0, ნამდვილი ფესვები არ არსებობს.

## გავრცელებული შეცდომები
± ნიშნის დავიწყება, ნიშნის შეცდომები, როცა b უარყოფითია, და ორივე მხარის x-ზე გაყოფა — ასე x = 0 ამონახსნი იკარგება.`,
  },
  {
...
Feedback should name one strength and one next step. Use hints before giving model solutions.`,
  ...
  {
    key: "ecosystems-reading-ka",
    owner: "eka",
    title: "საქართველოს ეკოსისტემები — საკითხავი",
    subject: "biology",
    grade: 7,
    author: "ეკა ჩხეიძე",
    tags: ["ეკოლოგია", "საკითხავი", "საქართველო"],
    visibility: "students",
    fileName: "sakartvelos-ekosistemebi.md",
    daysAgo: 30,
    text: `# საქართველოს ეკოსისტემები

საქართველო პატარა ქვეყანაა, მაგრამ აქ ბევრი ეკოსისტემაა: ალპური მდელოები დიდ კავკასიონზე, ტენიანი კოლხური ტყეები დასავლეთში, მშრალი ნახევარუდაბნოები ვაშლოვანში და ჭარბტენიანი ტერიტორიები შავი ზღვის სანაპიროზე.

## პროდუცენტები, კონსუმენტები და რედუცენტები
კოლხურ ტყეში წიფელი და წაბლი პროდუცენტებია: ისინი ფოტოსინთეზით მზის სინათლის ენერგიას საკვებად გარდაქმნიან. ირემი და გარეული ღორი ბალახისმჭამელი კონსუმენტებია. მგელი და მურა დათვი კვებითი ქსელის უფრო მაღალ დონეზე მყოფი კონსუმენტები არიან. სოკოები და ბაქტერიები რედუცენტებია: ისინი შლიან ჩამოცვენილ ფოთლებსა და მკვდარ ორგანიზმებს და საკვებ ნივთიერებებს ნიადაგს უბრუნებენ.

## ენერგია კვებით ჯაჭვებში
კვებითი ჯაჭვის ერთ დონეზე დაგროვილი ენერგიის მხოლოდ დაახლოებით ათი პროცენტი გადადის შემდეგ დონეზე. დანარჩენი სასიცოცხლო პროცესებზე იხარჯება ან სითბოს სახით იკარგება. ამიტომაა დათვი და მგელი ირემზე გაცილებით ნაკლები, ირემი კი — ხეებზე ბევრად ნაკლები.

## ეკოსისტემების დაცვა
ეროვნული პარკები, მაგალითად ბორჯომ-ხარაგაულისა და ლაგოდეხის, ჰაბიტატებს იცავს. ერთი სახეობის, მაგალითად მთავარი მტაცებლის, გაქრობამ შეიძლება მთელი კვებითი ქსელი შეცვალოს.`,
  },
  {
    key: "rubric-ka",
    owner: "nino",
    title: "შეფასების რუბრიკა ამოცანების ამოხსნისთვის",
    subject: "mathematics",
    grade: null,
    author: "მათემატიკის კათედრა",
    tags: ["შეფასება", "რუბრიკა", "მასწავლებლებისთვის"],
    visibility: "teachers",
    fileName: "shefasebis-rubrika.md",
    daysAgo: 45,
    text: `# ამოცანის ამოხსნის შეფასების რუბრიკა (მათემატიკის კათედრა)

დონე 4 — სრული და სწორი ამოხსნა, მკაფიო მსჯელობითა და პასუხის შემოწმებით.
დონე 3 — სწორი მეთოდი, მცირე გამოთვლითი შეცდომით; მსჯელობა ძირითადად მკაფიოა.
დონე 2 — ნაწილობრივ სწორი მეთოდი; საკვანძო ნაბიჯი აკლია ან არასწორია.
დონე 1 — ნაცადში ჩანს შესაბამისი ცოდნა, მაგრამ გამოსადეგი მეთოდი არ არის.

უკუკავშირში დაასახელეთ ერთი ძლიერი მხარე და ერთი შემდეგი ნაბიჯი. სანიმუშო ამოხსნის ჩვენებამდე გამოიყენეთ მინიშნებები.`,
  },
];
