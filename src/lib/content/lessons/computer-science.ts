...
• for i in range(a, b) იმეორებს i = a … b − 1 მნიშვნელობებისთვის.`,
    ...
    activities: [
      ...
      },
      {
        ...
        hints: [
          l("What type of value does input() return?", "რა ტიპის მნიშვნელობას აბრუნებს input()?"),
          l("\"5\" + \"5\" joins text. Convert the input to a number before adding.", "\"5\" + \"5\" ტექსტს აერთებს. შეკრებამდე შეყვანილი მნიშვნელობა რიცხვად გარდაქმენი."),
        ],
      },
      {
        type: "exercise",
        ...
        hints: [l("Check the conditions from the top: is 51 >= 91? Is 51 >= 51?", "პირობები ზემოდან შეამოწმე: 51 >= 91? 51 >= 51?"), l("The first condition that is true decides the branch.", "განშტოებას პირველი ჭეშმარიტი პირობა წყვეტს.")],
    ...
    activities: [
      {
        ...
        correct: 0,
        hints: [
          l("In C++, how does every statement end?", "C++-ში რით მთავრდება ყოველი ბრძანება?"),
          l("Compare it with the lines of the example program.", "შეადარე სანიმუშო პროგრამის სტრიქონებს."),
        ],
      },
      {
        type: "mc",
        ...
        correct: 0,
        hints: [l("int holds whole numbers up to about 2 147 483 647.", "int ინახავს მთელ რიცხვებს დაახლოებით 2 147 483 647-მდე."), l("3 000 000 000 is bigger than that. Which type holds much larger whole numbers?", "3 000 000 000 ამაზე მეტია. რომელი ტიპი ინახავს გაცილებით დიდ მთელ რიცხვებს?")],
      },
      {
        type: "exercise",
        ...
        accepted: ["30"],
        hints: [l("i takes the values 2, 4, 6, 8, 10.", "i იღებს მნიშვნელობებს 2, 4, 6, 8, 10."), l("Add them up.", "შეკრიბე ისინი.")],
      ...
      },
      {
        ...
        accepted: ["3"],
        hints: [l("Dividing two ints drops the fractional part.", "ორი int-ის გაყოფისას წილადი ნაწილი იკარგება."), l("7 / 2 = 3.5 in ordinary maths. What remains once the fractional part is dropped?", "ჩვეულებრივ მათემატიკაში 7 / 2 = 3,5. რა რჩება წილადი ნაწილის მოშორების შემდეგ?")],
    ...
    activities: [
      {
        ...
        hints: [
          l("What was left off the map, and why?", "რა არ არის რუკაზე და რატომ?"),
          l("Keeping only what matters for the purpose is one of the four tools.", "მხოლოდ მიზნისთვის მნიშვნელოვანის დატოვება ოთხი ინსტრუმენტიდან ერთ-ერთია."),
        ],
      },
      {
        type: "exercise",
        ...
        accepted: ["4"],
        hints: [l("Count the \"right\" commands.", "დაითვალე ბრძანებები „მარჯვნივ“."), l("Each group ends with one \"right\".", "ყოველი ჯგუფი ერთი „მარჯვნივ“-ით მთავრდება.")],
