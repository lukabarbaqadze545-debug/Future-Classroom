...
export const TERMS: Record<string, Term> = {
  ...
  output: { en: "Output", ka: "გამოსავალი მონაცემები", note: "What a program printed: „გამონატანი“." },
  ...
  researchQuestion: { en: "Research question", ka: "საკვლევი კითხვა" },
  ...
  bias: { en: "Cognitive bias", ka: "კოგნიტური მიკერძოება" },
